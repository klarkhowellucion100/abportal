...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (
    document.querySelectorAll(".testimonial-slide-three-wrapper").length > 0
  ) {
    tns({
  ...
  if (
    document.querySelectorAll(".chat-user-status-slides-wrapper").length > 0
  ) {
    tns({
  ...
  let formControlInputs = document.querySelectorAll(
