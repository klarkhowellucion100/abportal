<x-layout logoWrapper="back-button" logoHref="{{ route('orders.approvedindex') }}" pageTitle="Commitment Schedule"
    imageUrl="{{ url('pwa/icons/android/android-launchericon-72-72.png') }}" imageStyle="display:none;" imageIconStyle="">

    <div class="container">
        <div class="card bg-white mb-3">
            <div class="card-body">
                <form action="{{ route('orders.approvedshow', ['id' => request()->route('id')]) }}" method="GET">
                    <div class="input-group gap-1">
                        <a class="btn btn-success"
                            href="{{ route('orders.approvedshow', ['id' => request()->route('id')]) }}">All</a>
    ...
    <div class="container" id="commitment-commodities">
        <div class="card bg-white mb-3" id="commodities-today">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('orders.approvedcancel') }}" id="actionForm">
                    @csrf
